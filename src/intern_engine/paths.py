...
OBSERVED_PATH = os.path.join(DATA_DIR, "observed.json")
KNOWN_WINDOWS_PATH = os.path.join(DATA_DIR, "known_windows.json")
...
RADAR_ICS_PATH = os.path.join(DOCS_DIR, "radar.ics")
